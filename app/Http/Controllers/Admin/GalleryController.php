...
class GalleryController extends Controller
{
    ...
    public function index()
    {
        ...
        $galleries = Gallery::with('images','services')->orderBy('created_at','desc')->get();
        $serviceDetails = ServiceDetail::where('status',Status::Active)->orderBy('name','asc')->get();
        return view('admin.gallery.index',compact('galleries','serviceDetails'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (isset($request->services)){
            $gallery->services()->sync($request->services);
        }
