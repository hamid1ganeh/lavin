    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            [
                ...
                'consumption_stock' => ['required','integer'],
                'consumption_price' => ['required','integer'],
            ...
            [
                ...
                'consumption_unit.required' => 'واحد مصرفی  کالا الزامی است.',
                'consumption_stock.required' => 'موجودی مصرفی کالا الزامی است.',
                'consumption_stock.numeric' => 'موجودی مصرفی کالا میبایست یک عدد مثبت باشد.',
                'consumption_price.required' => 'قیمت مصرفی کالا الزامی است.',
        ...
        if(in_array($request->status,[Status::Active,Status::Deactive])){
            Goods::create([
                ...
                'consumption_stock' => $request->consumption_stock,
