    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            [
                ...
                'count_per_box' => ['required','integer'],
                'box_stock' => ['required','integer'],
            ...
            [
                ...
                'box_stock.required' => ' موجودی جعبه در انبار الزامی است.',
                'box_stock.numeric' => ' موجودی جعبه در انبار میبایست یک عدد مثبت باشد.',
