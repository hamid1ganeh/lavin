...
class RegisterComplication extends Model
{
    protected $fillable = ['reserve_id','description'];
    ...
    {
        return CalendarUtils::convertNumbers(CalendarUtils::strftime('d %B Y',strtotime($this->crated_at)));
    }
    ...
    {
        switch ($this->status) {
            case ComplicationStatus::pending:
                $res = "درانتظار";
                break;
            case ComplicationStatus::following:
                $res = "در حال پیگیری";
                break;
            case ComplicationStatus::followed:
                $res = "پیگیری شده";
                break;
            case ComplicationStatus::cancel:
                $res = "رد شده";
                break;
        }
        return  $res;
