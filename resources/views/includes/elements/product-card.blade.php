...
<div class="w-100 text-left" >
    @auth
        <a href="{{ route('website.shop.cart.add2cart',$product) }}" class="position-relative" style="top: -32px;left: 8px" title="افزودن به سبد خرید">
            <i class="fa fa-cart-plus fa-xs text-accent"></i>
        </a>
    @else
        <a href="#loginModal" data-toggle="modal" class="position-relative" style="top: -32px;left: 8px" title="افزودن به سبد خرید">
            <i class="fa fa-cart-plus fa-xs text-accent"></i>
        </a>
    @endauth
</div>
