                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                <form class="form-horizontal" action="{{ route('admin.analysis.store') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-right" name="min_price" id="min_price" placeholder="حداقل قیمت را وارد کنید..." value="{{ old('min_price') }}">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-right" name="max_price" id="max_price" placeholder="حداکثر قیمت را وارد کنید..." value="{{ old('max_price') }}">
