                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('accounting.reception.invoices.pos.edit',$reception,$receptionInvoice,$pos) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                                <i class="fas fa-dollar-sign page-icon"></i>
                             ویرایش پرداختی دستگاه پوز
                        </h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                <form class="form-horizontal" action="{{ route('admin.accounting.reception.invoices.pos.update',[$reception,$receptionInvoice,$pos]) }}" method="post">
                                    {{ csrf_field() }}
                                    @method('PUT')
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12 col-md-6">
                                            ...
                                            <input type="number" class="form-control input text-center" name="price" id="price" placeholder="مبلغ (تومان) وارد کنید" value="{{ old('price') ?? $pos->price }}" min="1000"  required>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-right" name="transaction_number" id="transaction_number" placeholder=" شماره تراکنش را وارد کنید" value="{{ old('transaction_number') ?? $pos->transaction_number }}" required>
                                        ...
                                        <div class="form-group col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-center" name="paid_at" id="paid_at" placeholder="تاریخ  پرداخت وارد کنید" value="{{ old('paid_at') ?? $pos->paidAt() }}" readonly required>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            ...
                                            <input type="text" class="form-control input" name="description" id="description" placeholder=" توضیحات را وارد کنید" value="{{ old('description') ?? $pos->description }}">
