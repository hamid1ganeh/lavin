                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 text-right">
                                    ...
                                    <div class="btn-group" >
                                        <a href="{{ route('admin.accounting.reception.invoices.cash.create',[$reception,$receptionInvoice]) }}" class="btn btn-sm btn-primary">
                                                    ...
                                                    <div class="modal-dialog modal-xs">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form action="{{ route('admin.accounting.reception.invoices.cash.destroy', [$reception,$receptionInvoice,$cash]) }}"  method="POST" class="d-inline">
                                                                    @csrf
                                                                    @method('DELETE')
