                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('accounting.reception.invoices.card.create',$reception,$receptionInvoice) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                                <i class="fas fa-dollar-sign page-icon"></i>
                             ایجاد پرداختی جدید کارت به کارت
                        </h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                <form class="form-horizontal" action="{{ route('admin.accounting.reception.invoices.card.store',[$reception,$receptionInvoice]) }}" method="post">
                                    {{ csrf_field() }}
