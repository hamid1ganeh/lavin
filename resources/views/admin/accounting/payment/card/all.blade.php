                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('accounting.reception.invoices.card',$reception,$receptionInvoice) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                                                    ...
                                                    <div class="modal-dialog modal-xs">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form action="{{ route('admin.accounting.reception.invoices.card.destroy', [$reception,$receptionInvoice,$card]) }}"  method="POST" class="d-inline">
                                                                    @csrf
                                                                    @method('DELETE')
