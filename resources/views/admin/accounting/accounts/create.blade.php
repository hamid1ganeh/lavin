                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                <form class="form-horizontal" action="{{ route('admin.accounting.accounts.store') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="form-group col-12 col-md-6">
                                            <label for="full_name" class="control-label IRANYekanRegular">نام و نام خانوادگی</label>
                                            <input type="text" class="form-control input" name="full_name" id="full_name" placeholder="نام و نام خانوادگی را وارد کنید" value="{{ old('full_name') }}" required>
                                        ...
                                        <div class="form-group col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-left" name="bank_name" id="bank_name" placeholder="نام بانک را وارد کنید" value="{{ old('bank_name') }}" required>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input" name="account_type" id="account_type" placeholder="نوع حساب را وارد کنید" value="{{ old('account_type') }}" required>
                                        ...
                                        <div class="form-group col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-center" name="opened_at" id="opened_at" placeholder="تاریخ افتتاح حساب را وارد کنید" value="{{ old('opened_at') }}" readonly required>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-right" name="cart_number" id="cart_number" placeholder="شماره کارت را وارد کنید" value="{{ old('cart_number') }}" required>
                                        ...
                                        <div class="form-group col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-right" name="account_number" id="account_number" placeholder="شماره حساب را وارد کنید" value="{{ old('account_number') }}" required>
                                    ...
                                    <div class="row mt-2 p-2">
                                        <div class="col-12" style="display:inherit;">
                                            <input type="radio" id="active" name="status" class="cursor-pointer" value="{{ App\Enums\Status::Active }}" @if(old('status')!=App\Enums\Status::Deactive) checked @endif>
                                            &nbsp;
                                            <label for="active" class="IRANYekanRegular">فعال</label><br>
                                            &nbsp;&nbsp; &nbsp;
                                            <input type="radio" id="deactive" name="status" class="cursor-pointer" value="{{ App\Enums\Status::Deactive }}" @if(old('status')==App\Enums\Status::Deactive) checked @endif>
                                            &nbsp;
