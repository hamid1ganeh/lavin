                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('employments.categories.sub.index',$main) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                             <i class="fas fa-layer-group page-icon"></i>
                                زیردسته های استخدام برای دسته اصلی {{ $main->title }}
                        </h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 text-right">
                                    @if(Auth::guard('admin')->user()->can('employments.categories.sub.create'))
                                    <div class="btn-group" >
                                            <a href="{{ route('admin.employments.categories.sub.create',$main) }}" class="btn btn-sm btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               @if($category->trashed())
                                                    ...
                                                    @if(Auth::guard('admin')->user()->can('employments.categories.sub.recycle'))
                                                        ...
                                                        <div class="modal-dialog modal-xs">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <h5 class="IRANYekanRegular">آیا مطمئن هستید که میخواید این زیردسته را بازیابی کنید؟</h5>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('admin.employments.categories.sub.recycle', [$main,$category]) }}" method="POST" class="d-inline">
                                                                        @csrf
                                                                        @method('patch')
                                                ...
                                                @else
                                                    @if(Auth::guard('admin')->user()->can('employments.categories.sub.edit'))
                                                        <a class="btn  btn-icon" href="{{ route('admin.employments.categories.sub.edit', [$main,$category]) }}" title="ویرایش">
                                                            <i class="fa fa-edit text-success font-20"></i>
                                                        </a>
                                                    @endif

                                                    @if(Auth::guard('admin')->user()->can('employments.categories.sub.destroy'))
                                                    ...
                                                    <div class="modal fade" id="remove{{ $category->id }}" tabindex="-1" aria-labelledby="reviewLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-xs">
                                                            <div class="modal-content">
                                                                <div class="modal-header py-3">
                                                                    <h5 class="modal-title IRANYekanRegular" id="newReviewLabel">حذف  زیردسته</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <h5 class="IRANYekanRegular">آیا مطمئن هستید که میخواهدی  زیردسته  {{ $category->title }} را حذف کنید؟</h5>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('admin.employments.categories.sub.destroy', [$main,$category]) }}"  method="POST" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
