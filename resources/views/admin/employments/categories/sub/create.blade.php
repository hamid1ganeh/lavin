                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('employments.categories.sub.create',$main) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                             <i class="fas fa-layer-group page-icon"></i>
                            ایجاد زیردسته  جدید استخدام برای دسته اصلی {{ $main->title }}
                        </h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                <form class="form-horizontal" action="{{ route('admin.employments.categories.sub.store',$main) }}" method="post">
                                    {{ csrf_field() }}
