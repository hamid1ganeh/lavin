                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('provinces.cities.parts.areas.edit',$province,$city,$part,$area) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                            <i class="fas fa-map-marker  page-icon"></i>
                            ویرایش محله برای  {{ $part->name }}  شهر  {{ $city->name }}
                        </h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                <form class="form-horizontal" action="{{ route('admin.provinces.cities.parts.areas.update',[$province,$city,$part,$area]) }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{ method_field('PATCH') }}
