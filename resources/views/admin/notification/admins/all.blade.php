                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('notifications.admins') }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="margin-bottom: 20px;">
                                ...
                                <div class="col-6 text-right">
                                     @if(Auth::guard('admin')->user()->can('notifications.admins.create'))
                                    <div class="btn-group">
                                        <a href="{{ route('admin.notifications.admins.create') }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="collapse" id="filter">
                                <div class="card card-body filter">
                                    <form id="filter-form">
                                        ...
                                        <div class="row">
                                            <div class="form-group justify-content-center col-6">
                                                <label for="admins-filter" class="control-label IRANYekanRegular">فرستندگان</label>
                                                <select name="admins[]" id="admins-filter" class="form-control select2 select2-multiple text-right IRANYekanRegular" multiple="multiple" multiple data-placeholder="... فرستادگان مورد نظر را انتخاب نمایید">
                                            ...
                                            <div class="form-group justify-content-center col-6">
                                                <label for="receivers-filter" class="control-label IRANYekanRegular">گیرندگان</label>
                                                 <select name="receivers[]" id="receivers-filter" class="form-control select2 select2-multiple text-right IRANYekanRegular" multiple="multiple" multiple data-placeholder="... گیرندگان مورد نظر را انتخاب نمایید">
                                                     @foreach($admins as $admin)
                                                         <option value="{{ $admin->id }}" @if(request('receivers')!=null) {{ in_array($admin->id,request('receivers'))?'selected':'' }} @endif>{{ $admin->fullname  }}</option>
                                                     @endforeach
                                                </select>
                                            </div>
                                         </div>
                                        ...
                                        <div class="form-group col-12 d-flex justify-content-center mt-3">
                                            ...
                                            <script>
                                                function reset()
                                                {
                                                    ...
                                                    $("#receivers-filter").val(null).trigger("change");
                                ...
                                <table id="tech-companies-1" class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><b class="IRANYekanRegular">ارسال پیامک</b></th>
                                    ...
                                    <tbody>
                                        @foreach($notifications as $index=>$notification)
                                            <tr>
                                                ...
                                                <td><strong class="IRANYekanRegular">{{ $notification->admin->fullname  }}</strong></td>
                                                <td>
                                                    @if($notification->sms)
                                                        <span class="badge badge-primary IR  p-1">بلی</span>
                                                    @elseif($notification->status==App\Enums\Status::Active)
                                                        <span class="badge badge-danger IR  p-1">خیر</span>
                                                    @endif
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="modal fade" id="info{{ $notification->id }}" tabindex="-1" aria-labelledby="reviewLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-xs">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-12 text-left">
                                                                            ...
                                                                            <p class="IRANYekanRegular text-justify"> {{ $notification->created_at() }}</p>                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12 text-left">
                                                                            @if($notification->sms)
                                                                                <span class="badge badge-primary IR  p-1">ارسال پیامک</span>
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12 text-left">
                                                                            ...
                                                                            <ul class="m-1">
                                                                                @foreach($notification->admins as $admin)
                                                                                <li class="IR">{{ $admin->fullname.' ('.$admin->mobile.')' }}</li>
                                                                                @endforeach
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    @if(Auth::guard('admin')->user()->can('notifications.admins.update'))
                                                                    <form action="{{ route('admin.notifications.users.update', $notification) }}"  method="POST" class="d-inline">
                                                                        @csrf
                                                                        @method('patch')
                                                                        @if($notification->status == App\Enums\Status::Deactive)
                                                        ...
                                                        @if(!$notification->trashed())
                                                            @if(Auth::guard('admin')->user()->can('notifications.admins.destroy'))
                                                            ...
                                                            <div class="modal fade" id="remove{{ $notification->id }}" tabindex="-1" aria-labelledby="reviewLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-xs">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <form action="{{ route('admin.notifications.admins.destroy', $notification) }}"  method="POST" class="d-inline">
                                                                                @csrf
                                                                                @method('DELETE')
                                                            ...
                                                            <div class="modal fade" id="recycle{{ $notification->id }}" tabindex="-1" aria-labelledby="reviewLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-xs">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <form action="{{ route('admin.notifications.admins.recycle',$notification->id) }}" method="post" class="d-inline">
                                                                                @csrf
