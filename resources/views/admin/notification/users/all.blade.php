                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0 IR">
                                    {{ Breadcrumbs::render('notifications.users') }}
                                </ol>
                            </div>
                            <h4 class="page-title">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row" style="margin-bottom: 20px;">
                                    ...
                                    <div class="col-6 text-right">
                                        @if(Auth::guard('admin')->user()->can('notifications.users.create'))
                                            <div class="btn-group">
                                                <a href="{{ route('admin.notifications.users.create') }}" class="btn btn-sm btn-primary">
                                    ...
                                    <div class="card card-body filter">
                                        <form id="filter-form">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group justify-content-center col-6">
                                                    <label for="users-filter" class="control-label IRANYekanRegular">گیرندگان</label>
                                                    <select name="users[]" id="users-filter" class="form-control select2 select2-multiple text-right IRANYekanRegular" multiple="multiple" multiple data-placeholder="... گیرندگان مورد نظر را انتخاب نمایید">
                                                        @foreach($users as $user)
                                                            <option value="{{ $user->id }}" @if(request('users')!=null) {{ in_array($user->id,request('users'))?'selected':'' }} @endif>{{ $user->firstname.' '.$user->lastname.' ('.$user->mobile.')' }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <div class="modal-dialog modal-xs">
                                                            <div class="modal-content">
                                                                        ...
                                                                        <div class="col-12 text-left">
                                                                            ...
                                                                            <ul class="m-1">
                                                                                @foreach($notification->users as $user)
                                                                                    <li class="IR">{{ $user->firstname.' '.$user->lastname.' ('.$user->mobile.')' }}</li>
                                                                                @endforeach
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    @if(Auth::guard('admin')->user()->can('notifications.users.update'))
                                                    ...
                                                    @if(!$notification->trashed())
                                                        @if(Auth::guard('admin')->user()->can('notifications.users.destroy'))
                                                            ...
                                                            <div class="modal fade" id="remove{{ $notification->id }}" tabindex="-1" aria-labelledby="reviewLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-xs">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <form action="{{ route('admin.notifications.users.destroy', $notification) }}"  method="POST" class="d-inline">
                                                                                @csrf
                                                                                @method('DELETE')
                                                            ...
                                                            <div class="modal fade" id="recycle{{ $notification->id }}" tabindex="-1" aria-labelledby="reviewLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-xs">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <form action="{{ route('admin.notifications.users.recycle',$notification->id) }}" method="post" class="d-inline">
                                                                                @csrf
