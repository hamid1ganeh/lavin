                            ...
                            @foreach($notifications as $notification)
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mt-2">
                                            <strong class="IR">
                                                <span class="text-muted">فرستنده:</span>
                                                {{ $notification->admin->fullname  }}
                                            </strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 mt-2">
                                            @if($notification->adminSeenStatus()==App\Enums\seenStatus::unseen)
                                            <span class="badge badge-danger IR  p-1">خوانده نشده</span>
                                            @elseif($notification->adminSeenStatus()==App\Enums\seenStatus::seen)
                                    ...
                                    <div class="col-12 text-right">
                                        <a   href="{{ route('admin.notifications.show', $notification) }}" title="نمایش">
