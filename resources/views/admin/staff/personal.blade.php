                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            {{ Breadcrumbs::render('staff.documents.personal') }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.staff.documents.personal.update')  }}" >
                                @csrf
                                @method('patch')
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        ...
                                        <input id="fullname" type="text" class="form-control @error('fullname') is-invalid @enderror" name="fullname"  value="{{ old('fullname') ?? $admin->fullname }}" placeholder="نام و نام خانوادگی">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="mobile" type="text" class="form-control ltr @error('mobile') is-invalid @enderror" name="mobile"  value="{{ old('mobile') ?? $admin->mobile }}" placeholder="موبایل">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="email" type="text" class="form-control ltr @error('email') is-invalid @enderror ltr" name="email"  value="{{ old('mobile') ?? $admin->email }}" placeholder="آدرس ایمیل">
