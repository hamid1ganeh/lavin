                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                <form class="form-horizontal" action="{{ route('admin.shop.products.categories.store') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="fileupload btn btn-success waves-effect waves-light mb-3">
                                            ...
                                            <input type="file" class="upload" name="thumbnail" id="thumbnail"  value="{{ old('thumbnail') }}">
