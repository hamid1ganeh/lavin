                                ...
                                <form class="form-horizontal" action="{{ route('admin.services.update',$service) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input" name="slogan" id="slogan" placeholder="شعار را وارد کنید" value="{{ old('slogan') ?? $service->slogan }}">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <select class='form-control dropdopwn' name='label' id='label'>
                                                ...
                                                <option value='{{ App\Enums\Lables::Suggested }}' class='dropdopwn' @if(App\Enums\Lables::Suggested==$service->label || old('label')==App\Enums\Lables::Suggested) selected @endif>{{ App\Enums\Lables::Suggested }}</option>
                                                <option value='{{ App\Enums\Lables::Popular }}' class='dropdopwn' @if(App\Enums\Lables::Popular==$service->label || old('label')==App\Enums\Lables::Popular) selected @endif>{{ App\Enums\Lables::Popular }}</option>
                                            </select>
