                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-append">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                @if(Auth::guard('admin')->user()->can('admins.documents.index'))
                                                                <a class="dropdown-item IR cusrsor"  href="{{ route('admin.admins.staff.documents', $admin) }}" title="پرونده پرسنلی">
                                                                ...
                                                                <a class="dropdown-item IR cusrsor"  href="{{ route('admin.admins.edit', $admin) }}" title="ویرایش">
