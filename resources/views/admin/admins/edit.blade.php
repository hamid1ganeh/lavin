                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="padding:70px;">
                            ...
                            <form method="POST" action="{{ route('admin.admins.update',$admin) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="branches" class="col-md-4 col-form-label text-md-right IRANYekanRegular">شعبه ها:</label>
                                    <div class="col-md-6">
                                        <select name="branches[]" id="branches" class="select2 select2-multiple text-right IRANYekanRegular" multiple="multiple" multiple data-placeholder="انتخاب شعبه ها...">
                                            @foreach($branches as $branch)
                                                <option value="{{ $branch->id }}" {{ in_array(trim($branch->id),$admin->branches->pluck('id')->toArray())?'selected':'' }}>{{ $branch->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <select name="gender" id="gender" class="dropdown text-right IRANYekanRegular"  data-placeholder="انتخاب جنسیت...">
                                            ...
                                            <option value="{{ App\Enums\genderType::female }}" {{ App\Enums\genderType::female==$admin->gender?'selected':'' }}>زن</option>
                                            <option value="{{ App\Enums\genderType::LGBTQ }}" {{ App\Enums\genderType::LGBTQ==$admin->gender?'selected':'' }}>LGBTQ</option>
                                        </select>
