                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            {{ Breadcrumbs::render('admins.staff.documents',$admin) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                             <i class="fa fa-file page-icon"></i>
                             پرونده پرسنلی {{ $admin->fullname }}
                         </h4>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="card" style="height: 140px;">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-2">
                                                        <a href="{{ route('admin.admins.staff.personal.index', $admin) }}"  class="fa fa-eye text-muted float-right" data-toggle="tooltip" data-placement="bottom" title="نمایش" data-original-title="نمایش"></a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card" style="height: 140px;">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-2">
                                                    <a href="{{ route('admin.admins.staff.educations.index', $admin) }}" class="fa fa-eye text-muted float-right" data-toggle="tooltip" data-placement="bottom" title="نمایش" data-original-title="نمایش"></a>
                                                </div>
                                            </div>
                                            <strong class="IRANYekanRegular">
                                    ...
                                    <div class="card" style="height: 140px;">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-2">
                                                    <a href="{{ route('admin.admins.staff.socialmedias.index', $admin) }}" class="fa fa-eye text-muted float-right" data-toggle="tooltip" data-placement="bottom" title="نمایش" data-original-title="نمایش"></a>
                                                </div>
                                            </div>
                                            <strong class="IRANYekanRegular">
                                            ...
                                            <img width="50px" src="{{ url('images/front/instagram.png') }}" alt="شبکه های اجتماعی">
                                           <br>
                                        </div>
                                    ...
                                    <div class="card" style="height: 140px;">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-2">
                                                    <a href="{{ route('admin.admins.staff.banks.index', $admin) }}" class="fa fa-eye text-muted float-right" data-toggle="tooltip" data-placement="bottom" title="نمایش" data-original-title="نمایش"></a>
                                                </div>
                                            </div>
                                            <strong class="IRANYekanRegular">
                                            ...
                                            <img width="50px" src="{{ url('images/front/bank.png') }}" alt="مشخصات بانکی">
                                            <br>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="card" style="height: 140px;">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-10">
                                                    <h4 class="card-title IR">بازآموزی ها</h4>
                                                </div>
                                                <div class="col-2">
                                                    <a href="{{ route('admin.admins.staff.retrainings.index', $admin) }}" class="fa fa-eye text-muted float-right" data-toggle="tooltip" data-placement="bottom" title="نمایش" data-original-title="نمایش"></a>
                                                </div>
                                            </div>
                                            <strong class="IRANYekanRegular">
                                            ...
                                            <img width="50px" src="{{ url('images/front/retraining.png') }}" alt="بازآموزی ها">
                                            <br>
                                        </div>
                                    </div>
                                </div>
