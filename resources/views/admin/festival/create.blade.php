                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                <form class="form-horizontal" action="{{ route('admin.festivals.store') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}

                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <label for="title" class="control-label IRANYekanRegular">عنوان جشنواره</label>
                                            <input type="text" class="form-control input" name="title" id="title" placeholder="عنوان جشنوراه را وارد کنید" value="{{ old('title') }}">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text"   class="form-control text-center" id="end" name="end"  readonly>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" row="500"  name="description" id="description" placeholder="توضیحات را وارد کنید...">{{ old('description') }}</textarea>
