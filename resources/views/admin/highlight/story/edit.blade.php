                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('stories.edit',$story) }}
                            </ol>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                <form class="form-horizontal" action="{{ route('admin.stories.update',$story) }}" method="post" id="form" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    @method('PATCH')
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input" name="title" id="title" placeholder="عنوان استوری را وارد کنید" value="{{ old('title') ?? $story->title }}">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <select name="highlight" id="highlight" class="form-control dropdown IR">
                                                ...
                                                @foreach($highlights as $highlight)
                                                    <option value="{{ $highlight->id  }}" @if($highlight->id == $story->highlight_id || old('highlight') == $story->highlight_id) selected @endif>{{ $highlight->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12">
                                        @if($story->image != null)
                                            <img src="{{  $story->image->getImagePath('medium') }}" width="200">
                                        @endif
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control input text-right" name="link" id="link" placeholder="لینک ویدئو را وارد کنید" value="{{ old('link') ?? $story->link ?? ''  }}">
                                    ...
                                    <div class="row mt-2 p-2">
                                        <div class="col-12" style="display:inherit;">
                                            <input type="radio" id="active" name="status" value="{{ App\Enums\Status::Active }}" @if(old('status')!=App\Enums\Status::Deactive || $story->status!=App\Enums\Status::Deactive) checked @endif>
                                            &nbsp;
                                            <label for="active" class="IR">فعال</label><br>
                                            &nbsp;&nbsp; &nbsp;
                                            <input type="radio" id="deactive" name="status" value="{{ App\Enums\Status::Deactive }}" @if(old('status')==App\Enums\Status::Deactive || $story->status==App\Enums\Status::Deactive) checked @endif>
                                            &nbsp;
                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <input type="submit"  value="بروزرسانی" class="btn btn-primary" form="form">
                                    </div>
                                </div>
