                                    ...
                                    <div class="row my-1">
                                        <div class="col-6">
                                            ...
                                            <select class="form-control IR" name="type" id="type">
                                                ...
                                                <option value="{{ App\Enums\ReviewGroupType::Adviser }}" @if(App\Enums\ReviewGroupType::Adviser==old('type') || App\Enums\ReviewGroupType::Adviser==$group->type ) {{ 'selected' }} @endif>مشاوره تلفنی</option>
                                            </select>
