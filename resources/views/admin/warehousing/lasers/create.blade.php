                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('warehousing.lasers.create') }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                <form class="form-horizontal" action="{{ route('admin.warehousing.lasers.store') }}" method="post">
                                     @csrf

                                    <div class="form-group row">
                                        <div class="col-12 col-md-6">
                                            <label for="name" class="control-label IRANYekanRegular">نام دستگاه</label>
                                            <input type="text" class="form-control input" name="name" id="name" placeholder="عنوان دستگاه را وارد کنید" value="{{ old('name')  }}" required>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input" name="brand" id="brand" placeholder="برند دستگاه را وارد کنید" value="{{ old('brand')  }}" required>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-right" name="model" id="model" placeholder="مدل دستگاه را وارد کنید" value="{{ old('model')  }}" required>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-right" name="code" id="code" placeholder="کد دستگاه را وارد کنید" value="{{ old('code')  }}" required>
