                                ...
                                <form class="form-horizontal" action="{{ route('admin.warehousing.goods.update',$good) }}" method="post">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div id="sub_div">
                                                <select name="sub_cat_id" id="sub_cat_id"  class="form-control IRANYekanRegular">
                                                    ...
                                                    @foreach($subs as $sub)
                                                        <option value="{{ $sub->id }}" {{$sub->id == old('sub_cat_id') || $main->id == $good->sub_cat_id?'selected':'' }}>{{ $sub->title }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-md-2">
                                            ...
                                            <input type="text" class="form-control input text-right" name="count_per_box" id="count_per_box" placeholder="تعداد در هر جعبه را وارد کنید" value="{{ old('count_per_box') ?? $good->count_per_box  }}">
                                        ...
                                        <div class="col-12 col-md-2">
                                            ...
                                            <input type="text" class="form-control input text-right" name="box_stock" id="box_stock" placeholder="موجودی جبعه در انبار را وارد کنید" value="{{ old('box_stock') ?? $good->box_stock  }}">
