                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                             {{ Breadcrumbs::render('warehousing.categories.main.index') }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                             <i class="fas fa-layer-group page-icon"></i>
                              دسته بندی های اصلی کالاها
                        </h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 text-right">
                                    @if(Auth::guard('admin')->user()->can('warehousing.categories.main.create'))
                                    <div class="btn-group" >
                                            <a href="{{ route('admin.warehousing.categories.main.create') }}" class="btn btn-sm btn-primary">
                                ...
                                <table id="tech-companies-1" class="table table-striped">
                                    ...
                                    @foreach($categories as $index=>$category)
                                        <tr>
                                            ...
                                            <td>
                                               @if($category->trashed())
                                                    @if(Auth::guard('admin')->user()->can('warehousing.categories.main.recycle'))
                                                        ...
                                                        <div class="modal-dialog modal-xs">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('admin.warehousing.categories.main.recycle', $category) }}" method="POST" class="d-inline">
                                                                        @csrf
                                                                        @method('patch')
                                                ...
                                                @else
                                                    ...
                                                    @if(Auth::guard('admin')->user()->can('warehousing.categories.sub.index'))
                                                        <a class="btn  btn-icon" href="{{ route('admin.warehousing.categories.sub.index', $category) }}" title="دسته های فرعی">
                                                    ...
                                                    <div class="modal fade" id="remove{{ $category->id }}" tabindex="-1" aria-labelledby="reviewLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-xs">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('admin.warehousing.categories.main.destroy', $category) }}"  method="POST" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
