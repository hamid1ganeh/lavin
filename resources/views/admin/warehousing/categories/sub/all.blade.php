                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('warehousing.categories.sub.index',$main) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                             <i class="fas fa-layer-group page-icon"></i>
                                زیردسته های کالاها برای دسته اصلی {{ $main->title }}
                        </h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 text-right">
                                    @if(Auth::guard('admin')->user()->can('warehousing.categories.sub.create'))
                                    <div class="btn-group" >
                                            <a href="{{ route('admin.warehousing.categories.sub.create',$main) }}" class="btn btn-sm btn-primary">
                                    ...
                                    @foreach($categories as $index=>$category)
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               @if($category->trashed())
                                                    @if(Auth::guard('admin')->user()->can('warehousing.categories.sub.recycle'))
                                                        ...
                                                        <div class="modal-dialog modal-xs">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('admin.warehousing.categories.sub.recycle', [$main,$category]) }}" method="POST" class="d-inline">
                                                                        @csrf
                                                                        @method('patch')
                                                    ...
                                                    <div class="modal fade" id="remove{{ $category->id }}" tabindex="-1" aria-labelledby="reviewLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-xs">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('admin.warehousing.categories.sub.destroy', [$main,$category]) }}"  method="POST" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
