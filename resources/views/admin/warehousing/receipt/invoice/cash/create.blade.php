...
{{--                                {{ Breadcrumbs::render('admin.warehousing.receipts.invoice.cash.create',$receipt,$invoice) }}--}}
                            </ol>
                        </div>
                        <h4 class="page-title">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                <form class="form-horizontal" action="{{ route('admin.warehousing.receipts.invoice.cash.store',[$receipt,$invoice]) }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="row">
