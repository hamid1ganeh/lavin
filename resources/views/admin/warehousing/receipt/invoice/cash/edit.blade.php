...
{{--                                {{ Breadcrumbs::render('admin.warehousing.receipts.invoice.cash.edit',$receipt,$invoice,$cash) }}--}}
                            </ol>
                        </div>
                        <h4 class="page-title">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                <form class="form-horizontal" action="{{ route('admin.warehousing.receipts.invoice.cash.update',[$receipt,$invoice,$cash]) }}" method="post">
                                    {{ csrf_field() }}
                                    @method('PUT')
