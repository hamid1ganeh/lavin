                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('warehousing.receipts.create') }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                <form class="form-horizontal" action="{{ route('admin.warehousing.receipts.store') }}" method="post">
                                     @csrf
                                        <div class="row">
                                    ...
                                    <div class="row mt-2">
                                        <div class="form-group col-12 col-md-3">
                                            ...
                                            <input type="number" class="form-control input text-center" name="price" id="price" placeholder="جمع کل را وارد کنید" value="{{ old('price') }}" min="0" required>
                                        ...
                                        <div class="form-group col-12 col-md-3">
                                            ...
                                            <input type="number" class="form-control input text-center" name="discount" id="discount" placeholder="تخفیف را وارد کنید" value="{{ old('discount') ?? 0 }}" required min="0">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-left" name="description" id=description" placeholder="توضیحات را وارد کنید" value="{{ old('description')    }}">
