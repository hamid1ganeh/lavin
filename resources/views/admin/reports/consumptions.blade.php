                                    ...
                                    <table id="tech-companies-1" class="table table-striped">
                                        ...
                                        @foreach($consumptions as $index=>$consumption)
                                            <tr>
                                                ...
                                                <td><strong class="IRANYekanRegular">{{ number_format($consumption->price_per_unit??0)  }}</strong></td>
                                                <td><strong class="IRANYekanRegular">{{ number_format($consumption->total_price??0)  }}</strong></td>
