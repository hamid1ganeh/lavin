                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <strong class="IRANYekanRegular">نامحدود</strong>
                                                @endif
                                            </td>
                                            <td>

                                                @if($discount->used() == false)
                                                <span class="badge badge-info IR  p-1">قابل استفاده</span>
                                                @elseif($discount->expired())
                                                <span class="badge badge-danger IR  p-1">منقضی شده</span>
                                                @elseif($discount->used())
                                                <span class="badge badge-primary IR  p-1">استفاده شده</span>
                                                @endif
                                            </td>
