                                                ...
                                                <article class="timeline-item timeline-item-left">
                                                    <div class="timeline-desk">
                                                        <div class="timeline-box">
                                                            ...
                                                            <img class="rounded-circle" src="{{ Gravatar::get( $message->senderable->email) }}" alt="{{ $message->senderable->fullname }}" title="{{ $message->senderable->fullname   }}" width="50px">
                                                            <h4 class="mt-0 font-16 IRANYekanRegular">{{ $message->senderable->fullname	 }}</h4>
                                                    ...
                                                    <article class="timeline-item">
                                                        <div class="timeline-desk">
                                                            <div class="timeline-box">
                                                                ...
                                                                <img class="rounded-circle" src="{{ Gravatar::get( $message->senderable->email()) }}" alt="{{ $message->senderable->getFullName() }}" title="{{ $message->senderable->getFullName() }}" width="50px">
                                                                <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                                                <h4 class="mt-0 font-16 IRANYekanRegular">{{ $message->senderable->getFullName() }}</h4>
                                                                <p class="text-muted"><small class="IRANYekanRegular">{{  $message->date()  }}</small></p>
                                                                <p class="mb-0 IR ticket-text">{{ $message->content }}</p>
