        ...
        <div class="col-12">
            <div class="col-12 d-flex justify-content-center">
                <form   id="search-form" class="col-md-5">
                    ...
                    <small style="color: #c9c9c9">جستجو در میان نمونه کارها ، مقالات ، محصولات و اسامی پزشکان</small>
                </form>
            </div>
            <div class="container">
                <div class="col-12 row mx-0 px-0">
                    <div class="col-md-9">
                        ...
                        <div class="b-crumb heading-4 col-12  text-pink mt-2 mb-4">{{ request('search') }}</div>
                    </div>
                    <div class="col-md-3 text-left">
                        ...
                        <div class="mb-1 font-11">
                            <span onclick="sectionController(this, 'product')" class="bg-gray-lighter px-2 py-1 d-inline-block text-center"
                                  style="width: 120px"><i class="fa fa-times ml-1 float-right my-1"></i>مشاهده محصولات</span>
                        </div>
                        <div class="mb-1 font-11">
                ...
                <section id="products" class="col-12 mx-0 row mt-3">
                    <div class="col-12 text-black pb-3">در محصولات</div>
