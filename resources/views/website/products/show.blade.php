                ...
                <div class="px-xl-4">
                    ...
                    <div class="rounded col-12 py-3" style="border:2px solid #2ed3ae;background-color: rgba(255,255,255,0.45)">
                        ...
                        <div class="col-12 text-center mt-3">
                            ...
                            @else
                                <a href="#loginModal" data-toggle="modal" class="button bg-accent border-0 text-white py-2">افزودن به سبد خرید</a>
                            @endauth
                        </div>
                    </div>
                </div>
        ...
        <div class="modal" id="review-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    ...
                    <form action="{{ route('website.shop.products.review',$product) }}" method="post">
                        @csrf
