    ...
    <div id="service">
        ...
        <div class="row mx-0 col-12 px-0 px-xl-5 pb-3">
            ...
            <div class="col-md-5">
                ...
                <div class="mt-4">
                    <span class="badge badge-secondary rounded shadow-sm px-2 ml-1">{{ $service->service->parent_cat->name }}</span>
                    <span class="badge badge-secondary rounded shadow-sm px-2">{{ $service->service->child_cat->name }}</span>
                </div>
                <p class="mt-1 pl-0 pl-xl-5">{{ $service->breif }}</p>
                <div class="h4 text-accent text-center text-md-right"><span data-price="true">{{ $service->price }}</span>  تومان</div>
            </div>
            <div class="col-md-4 text-dark">
                ...
                <div class="px-xl-4">
                    ...
                    <form class="rounded col-12 py-3" style="border:2px solid #2ed3ae;background-color: rgba(255,255,255,0.45)" method="POST" action="{{ route('website.services.reserve',[$service->service,$service]) }}">
                        ...
                        <div>انتخاب شعبه</div>
                        <div>
                            <select name="branch_id" class="custom-select small w-100">
                                <option disabled selected> شعبه مورد نظر را انتخاب کنید</option>
    ...
    <div class="col-12 my-5 bg-light py-4">
        ...
        <div class="col-12 row mx-0 justify-content-center mt-5">
            ...
            <div class="text-center px-1 mb-3 mb-md-5">
                <a href="{{ route('website.services.show',$detail->slug ) }}">
